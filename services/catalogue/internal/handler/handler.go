// Package handler wires HTTP to service calls for the catalogue service.
package handler
...
func New(svc *service.CatalogueService) *Handler {
	return &Handler{
		svc:      svc,
...
// Catalogue operations are always scoped to a single store.
